...
from backend.nodes.sleep_teams.analyze_sleep_node import create_analyze_sleep_agent, \
    create_analyze_sleep_node
...
def build_sleep_graph(llm_agents, llm_supervisor):
    ...
    sleep_team_supervisor=make_supervisor_sleep(llm_supervisor, ["analyze_sleep_node", "analyze_heart_node"])
